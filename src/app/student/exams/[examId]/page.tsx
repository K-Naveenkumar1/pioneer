...
export default function LockdownExamPage() {
    ...
    if (completed) {
        return (
            <div className="fixed inset-0 bg-black/85 z-50 flex items-center justify-center p-6 backdrop-blur-sm animate-fade-in">
                <div className="w-full max-w-2xl p-8 bg-zinc-900/90 border border-zinc-800 rounded-3xl space-y-6 shadow-2xl relative animate-scale-up">
                    ...
                    {isPending ? (
                        ...
                        <p className="text-sm text-red-400 text-center">Failed to grade attempt. Please contact an admin.</p>
                    )}
                </div>
            </div>
        )
                ...
                <aside className="w-88 md:w-[380px] shrink-0 flex flex-col hidden md:flex overflow-hidden p-0">
                    <div className="flex-1 bg-[#121212] rounded-xl p-5 flex flex-col justify-between shadow-xl overflow-hidden">
                        ...
                        <div className="border-t border-zinc-800/40 pt-3.5 mt-4 space-y-2 text-[10px] md:text-xs text-zinc-400">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="h-2.5 w-2.5 rounded-full bg-purple-600" /> Mark Review
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="h-2.5 w-2.5 rounded-full bg-white" /> Selected
                            </div>
                        </div>
                    </div>
                </aside>
